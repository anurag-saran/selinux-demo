...
**Fast compiles:** pull **`docker.io/asaran/selinux-demo-selinux-build:stream9`** from Docker Hub (published). See [DOCKER_HUB_COMPILE_IMAGE.md](../../../admin/COMPILE_IMAGE.md).
